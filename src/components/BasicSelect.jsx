    ...
    render() {
        ...
        return (
                ...
                <>
                    ...
                    <select id="basicselect" value={this.props.basic} className="form-select mb-3" onChange={(e) => this.handleBasicSelect(e)} multiple={false} aria-label="Default select example" required >
